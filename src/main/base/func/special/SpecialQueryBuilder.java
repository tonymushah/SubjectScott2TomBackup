...
public class SpecialQueryBuilder {
    ...
    public static void freeReq(Connection conn, PreparedStatement ps, ResultSet rs) throws SQLException {
        rs.close();
        ps.close();
        conn.close();
    }
...
public static PreparedStatement getPstmtFor_SALAIRE_DEPT(Connection conn, String date, String tableName, V_SALAIRE_DEPT_PROCHE where) throws SQLException, ReflectiveOperationException {    
    LinkedHashMap<String, Object> lh = DBQueryManager.getColumnNotNull(where);
