...
import main.frontend.search.helpers.FicheSalaireGetParam;
...
public class PageHelper {
    ...
    public static String getContentForInsertPage()
    ...
    public static String getSalaireSearch() {
        String form = FormBuilder.createGetForm(FicheSalaireGetParam.class, "../FicheSalaire/affichage", "", false);
        return BodyBuilder.makeDefaultBody(form);
    }
}
